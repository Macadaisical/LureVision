/**
 * Export functionality for aquatic vision results
 */
...
export class ImageExporter {
   ...
   */
  static exportPNG(imageData: ImageData, filename: string = 'aquatic-vision.png'): void {
  ...
  static exportCollage(
    ...
    ctx.fillText(
      'Generated by AquaticVision • Underwater light attenuation modeled with Beer-Lambert law',
      canvas.width / 2,
      footerY + 16
    );
